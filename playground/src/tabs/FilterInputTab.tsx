...
export const TOKEN_GROUPS: TokenGroupDef[] = [
  {
    ...
    tokens: [
      ...
      { key: '--bk-popover', type: 'color', description: 'Dropdown popup surface' },
      { key: '--bk-popover-foreground', type: 'color' },
      { key: '--bk-muted', type: 'color', description: 'Hover backgrounds, tag fill' },
      { key: '--bk-muted-foreground', type: 'color', description: 'Placeholder, count display' },
      { key: '--bk-border', type: 'color', description: 'Outer borders, popup border' },
      { key: '--bk-input', type: 'color', description: 'Input field border' },
      { key: '--bk-ring', type: 'color', description: 'Focus ring' },
      { key: '--bk-primary', type: 'color', description: 'Checked checkbox fill' },
      { key: '--bk-primary-foreground', type: 'color' },
      { key: '--bk-destructive', type: 'color', description: 'Required marker' },
      { key: '--bk-radius', type: 'dimension', rangeMin: 0, rangeMax: 16 },
    ],
  },
  {
