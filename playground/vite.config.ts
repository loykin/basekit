...
export default defineConfig({
  ...
  resolve: {
    alias: [
      ...
      { find: '@loykin/control-bar', replacement: resolve(__dirname, '../packages/control-bar/src/index.ts') },
      { find: '@loykin/cron-input', replacement: resolve(__dirname, '../packages/cron-input/src/index.ts') },
